...
public class MyLog {
    ...
    //private static String MYLOG_PATH_SDCARD_DIR969 = ASDConstant.rootDir969+"/log";// 日志文件在sdcard中的路径
    private static String MYLOG_PATH_SDCARD = Environment.getExternalStorageDirectory() + File.separator + "asd989" + "/netLog";// 日志文件在sdcard中的路径
    ...
    private static void log(String tag, String msg, char level) {
        if (MYLOG_SWITCH) {//日志文件总开关
            ...
            MYLOG_PATH_SDCARD_DIR = MYLOG_PATH_SDCARD;
